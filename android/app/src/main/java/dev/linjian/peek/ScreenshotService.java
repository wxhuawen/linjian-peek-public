...
public class ScreenshotService extends AccessibilityService {
    ...
    private static volatile String screenTextLite = "";
    ...
    public static String screenTextLite() { return screenTextLite == null ? "" : screenTextLite; }
    ...
    @Override public void onServiceConnected() {
        ...
        instance = this;
        NowState.start(this);
        DebugState.append(this, "无障碍服务已连接：截图/读屏/节点坐标/活动轨迹/远程息屏可用 v0.3.7.1");
    ...
    @Override public void onAccessibilityEvent(AccessibilityEvent event) {
        ...
        // Notification events can come from a background app. Only an actual
        // foreground-window transition is allowed to replace currentPackage.
    ...
    private void startBackgroundPolling() {
        ...
        DebugState.append(this, "无障碍兜底轮询已启动 v0.3.7.1（前台服务运行时不重复轮询）");
    ...
    private void updateScreenText() {
        try {
            ...
            // The notification shade belongs to System UI, not the foreground
            // app. A package mismatch means the window changed while this
            // snapshot was being collected, so return no lite text rather than
            // attaching stale text to the wrong app.
            ...
            screenTextLite = lite.length() > 400 ? lite.substring(0, 400) : lite.toString();
            screenNodesJson = nodes.toString();
            if (root != null) root.recycle();
        } catch (Exception ignored) { screenTextLite = ""; }
    }
    ...
    /** Collect only active-window text; secret, OTP, and card input values are excluded locally. */
